# dice module need for loading presets
import dice # NOQA
...
class Spell:
    def __init__(self, attacker, ntargets=1, damageDice=[],
                 modifer=lambda a, t: 0, modiferDesc='', name='spell'):
    ...
    def damage(self, target):
        return (sum(d.roll() for d in self.damageDice) +
                self.modifer(self.attacker, target))
